...
- **Таймзона SCADA — фиксированный UTC+6** (`Etc/GMT-6`), перехода на UTC+5 в марте 2024 нет:
  25 непрерывных 10-мин строк вокруг 2024-03-01 00:00 в обоих файлах, pooled-пик xcorr ветра 6.0–6.2 ч до и 5.8–6.0 ч (IFS 9 км и ERA5; помесячно 5.2–6.7 ч)
...
- **Previous Runs**: `<var>_previous_dayN` на час h дня D = ран D-N того же 6-часового блока, lead 24–29 ч (day1) /
  48–53 ч (day2). Проверено 1:1 против Single Runs для ecmwf_ifs. Старт архива: icon/gfs 2024-02-16, ifs025 2024-03-06,
  aifs (id `ecmwf_aifs025_single`) 2025-02-18, ecmwf_ifs 9 km 2025-10-01. `best_match` — никогда.
